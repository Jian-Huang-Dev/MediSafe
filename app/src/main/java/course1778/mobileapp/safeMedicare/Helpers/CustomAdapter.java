...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.drawer, null);
        holder.tv=(TextView) rowView.findViewById(R.id.drawer_name);
        holder.img=(ImageView) rowView.findViewById(R.id.drawer_picture);
